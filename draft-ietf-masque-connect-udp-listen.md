...
UDP port of the UDP packet received by the proxy.
...
A client MUST NOT open an uncompressed Context ID if one is already open. If
...
IP-literal, IPv4address, and port from {{Section 3.2 of !URI=RFC3986}}.
